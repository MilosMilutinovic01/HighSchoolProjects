...
{
    public partial class Po_arheologu : Form
    {
        public Po_arheologu()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            INNER JOIN Arheolog on Antikvitet.ArheologID=Arheolog.ArheologID
            WHERE Arheolog.ArheologID=@ID";
        ...
        private void Po_arheologu_Paint(object sender, PaintEventArgs e)
        {
            Graphics g = pictureBox1.CreateGraphics();
